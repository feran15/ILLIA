    ...
    <aside className="w-64 min-h-screen flex flex-col bg-sidebar border-r border-sidebar-border">
      ...
      <div className="p-4">
        <div className="rounded-xl bg-gradient-to-br from-primary/10 to-accent/10 border border-primary/20 p-4">
          <p className="text-xs font-display font-semibold text-primary mb-1">✨ Pro Tip</p>
          <p className="text-xs text-muted-foreground leading-relaxed">Use AI trends to find what's hot and generate captions in seconds.</p>
        </div>
      </div>
    </aside>
  );
